...
         let columnPossibilities = [1,2,3,4,5,6,7,8,9];    
        ...
                     rowPossibilities.splice(x, 1)}; // remove from row possibilities
                };
            };
...
            if(possibilities.length == 1){obj[a].value=possibilities[0]; 
            };
        };
}; 
...
      if ((405 - sum) == 0){console.log("----------Sudoku is done!!!----------");      

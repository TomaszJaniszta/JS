//Zadania 2021.10.16 Tomasz Janiszta
//-----------------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------------
console.log(
  'Task 3) Calculate the sum of the odd items [1,6,23,8,4,98,3,7,3,98,4,98]',
)
...
//-----------------------------------------------------------------------------------------------------
console.log(
  'Task 9) With a given start value of 0. Iterate the array and add even items and subtract odd ones. [1,6,23,8,4,98,3,7,3,98,4,98]',
)
let valueArray = [1, 6, 23, 8, 4, 98, 3, 7, 3, 98, 4, 98]
let sum = 0
for (let i = 0; i < valueArray.length; i++) {
